...
def create_sunburst_data(
    ...
    for family in flora_families_sorted:
        ...
        if addColor < 80:
            ...
            pass
        #create children
        children= create_sunburst_base_children(family, flora_families, color=f"hsl({color_hsl.h},{color_hsl.s}%,{color_hsl.l}%)")  
    ...
    for family in herpetofauna_families_sorted:
        ...
        if addColor < 80:
            ...
            pass
        #create children
        children= create_sunburst_base_children(family, herpetofauna_families, color=f"hsl({color_hsl.h},{color_hsl.s}%,{color_hsl.l}%)") 
    ...
    for family in mammals_families_sorted:
        ...
        if addColor < 80:
            ...
            pass
        #create children
        children= create_sunburst_base_children(family, mammals_families, color=f"hsl({color_hsl.h},{color_hsl.s}%,{color_hsl.l}%)")
